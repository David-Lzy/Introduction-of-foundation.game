...
This section collects high-value event notes for guild scheduling, battlefield execution, and time-sensitive activities in *Foundation: Galactic Frontier*.
...
- For guild roster discipline and control-point PvP: start with Shadowfront
...
- Event details can change with live versions and server progress
- For cooldowns, schedules, or open windows, the in-game panel always overrides written notes
- In guild events, poor timing and poor coordination usually hurt more than raw power gaps
