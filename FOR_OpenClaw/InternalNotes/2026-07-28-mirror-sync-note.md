...
- 复核 `FOR_OpenClaw/intel/reports/2026-07-28.md`：评分候选 2 个、通过入库 0 个、高价值增量 0 个。
...
- 对全部 159 个玩家 Markdown 文件执行 `glossary.yml` banned-term 扫描，禁用词残留为 **0**；没有术语漂移需要纠正，也无高频新术语需要补录。
- `npm run docs:build` 通过；仅允许保留既有的 Vite chunk 大小告警。
